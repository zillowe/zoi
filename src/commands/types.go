...
var packageManagers = map[string]PackageManager{
	"scoop": {
		...
		InstallCmd:   "scoop update && scoop install %s",
	...
	"apt": {
		...
		InstallCmd:   "sudo apt update -y && sudo apt install -y %s",
	...
	"pacman": {
		...
		InstallCmd:   "sudo pacman -Sy --noconfirm %s",
	...
	"dnf": {
		...
		InstallCmd:   "sudo dnf update -y && sudo dnf install -y %s",
	...
	"yum": {
		...
		InstallCmd:   "sudo yum update -y && sudo yum install -y %s",
	...
	"apk": {
		...
		InstallCmd:   "sudo apk update && sudo apk add %s",
	...
	"brew": {
		...
		InstallCmd:   "brew update && brew install %s",
