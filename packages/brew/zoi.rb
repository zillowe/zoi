...
class Zoi < Formula
  ...
  on_macos do
    ...
    if Hardware::CPU.intel?
      ...
      sha256 "4db08fe12cd443f89cb2dc6dbd6d7ce9d773461fb27b1013dde9ee56ccca4046"
    end

    on_linux do
      if Hardware::CPU.intel? and Hardware::CPU.is_64_bit?
        url "https://gitlab.com/Zillowe/Zillwen/Zusty/Zoi/-/releases/#{_tag}/downloads/zoi-linux-amd64.tar.zst"
        sha256 "9fde995ae285e5aaca32c18fd1ea6b65e2de50d70dd705b8f263048c1d8447cb"
      end

      if Hardware::CPU.arm? and Hardware::CPU.is_64_bit?
        url "https://gitlab.com/Zillowe/Zillwen/Zusty/Zoi/-/releases/#{_tag}/downloads/zoi-linux-arm64.tar.zst"
        sha256 "2789a2dcf9cf75c4ed88abc1d06c6b7d8104d0a4cf6f4bdc89140dfd515a4227"
      end
    end
