...
/// # Errors
///
/// Returns an error if the extension package cannot be resolved, if it's not an
/// extension package, or if applying any of the changes fails.
pub fn add(
    ext_name: &str,
    yes: bool,
...
/// # Errors
///
/// Returns an error if the extension is not installed, if it's not an extension
/// package, or if reverting any of the changes fails.
pub fn remove(
    ext_name: &str,
    yes: bool,
    plugin_manager: Option<&PluginManager,>,
