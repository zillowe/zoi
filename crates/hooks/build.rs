...
//!
//! This script reads all YAML hook definitions from the `builtin/hooks`
//! directory and generates a Rust source file containing them as static
//! strings.
...
/// Reads and sorts the paths of files with the specified extension in a
/// directory.
...
fn main() -> Result<(), Box<dyn Error,>,> {
    ...
    writeln!(
        ...
        "/// A list of built-in transaction hooks.\n///\n/// Each entry is a \
         tuple of (`hook_name`, `raw_yaml_content`).\npub static \
         BUILTIN_HOOKS: &[(&str, &str)] = &["
    )?;
