...
**NOTE: If your issue is a security concern, please contact me on [Matrix](https://matrix.to/#/@ZilloweZ:matrix.org>) or open a [Vulnerability Report](https://gitlab.com/Zusty/Zoi-Pkgs/-/security/vulnerability_report) instead of opening a public issue.**
...
- [ ] I have checked the [existing issues](https://gitlab.com/Zusty/Zoi/-/issues?scope=all&state=all&label_name[]=Kind%2FBug) to ensure this is not a duplicate.
