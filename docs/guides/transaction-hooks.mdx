...
| `trigger.paths`     | `list`   | A list of glob patterns. If any modified file matches, the hook triggers. Also supports Arch-style directory paths ending in `/`. |
