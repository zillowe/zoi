...
1. **`zoi.lua`**: Defines your project's dependencies.
...
Zoi will detect the `zoi.lua` and `zoi.lock` files and provision the project-local environment exactly as it was when the lockfile was created.
