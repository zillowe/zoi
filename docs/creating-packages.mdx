...
| `platforms`      | `list`    | A list of supported platforms (e.g. `linux`, `macos`, `windows`, `linux-amd64`). If specified, builds for other platforms will be skipped. |
...
## 11. Full Walkthrough: 'hello' Package
