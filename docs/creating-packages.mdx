...
`zoi package doctor` validates metadata consistency, dependency string syntax, and common split-package mistakes, and emits warnings for missing lifecycle functions like `test()`.
