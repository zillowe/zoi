...
| `zlicense(source)`                        | Convenience function to copy a license file to `${pkgstore}/LICENSE`.                                                                                                                                                                    |
| `zdoc(source)`                            | Convenience function to copy a documentation file to `${pkgstore}/doc/{filename}`.                                                                                                                                                       |
...
- `--fakeroot`: Force root ownership (UID/GID 0) in the built archive. Useful for official registry packages.
