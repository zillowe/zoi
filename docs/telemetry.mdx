...
**We do not and will never collect any personal or identifying information.** We do not track your IP address, hostname, or any other data that is not explicitly listed above. The code that collects and sends this data is fully open-source and can be reviewed in `crates/telemetry/src/lib.rs`.
