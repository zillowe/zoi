...
When you choose to enable telemetry, Zoi sends a secure, anonymous event to a PostHog cloud-hosted instance when you perform certain actions. The data we collect is strictly limited to the following fields:
