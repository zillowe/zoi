...
When you choose to enable telemetry, Zoi sends a secure, anonymous event to our self-hosted PostHog instance when you perform certain actions. The data we collect is strictly limited to the following fields:
