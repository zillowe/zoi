...
links:
  - label: "Docs.rs"
    url: "https://docs.rs/zoi-rs/latest/zoi"
    icon: "FaRust"
  - label: "Crates.io"
...
```toml
[dependencies]
zoi-rs = "1" # Imported as `zoi` in Rust code
```
...
<Cards>
  <Card title="build_with_options" href="#build_with_options-function" description="Builds a Zoi package using a typed options struct." />

  <Card title="build" href="#build-function" description="Compatibility wrapper for building a Zoi package." />

  <Card title="install_sources" href="#install_sources-function" description="Installs packages from registry, local file, URL, or git-backed sources." />

  <Card title="resolve_package" href="#resolve_package-function" description="Resolves a source string into a package, version, and origin metadata." />

  <Card title="resolve_dependency_graph" href="#resolve_dependency_graph-function" description="Returns the dependency graph for one or more requested sources." />

  <Card title="install_package_with_options" href="#install_package_with_options-function" description="Installs a local package archive using a typed options struct." />

  <Card title="install_package" href="#install_package-function" description="Compatibility wrapper for installing a local package archive." />

  <Card title="uninstall_package" href="#uninstall_package-function" description="Uninstalls a Zoi package." />
</Cards>
...
When `frozen_lockfile` is `true`, `install_sources` follows the exact entries recorded in `zoi.lock` rather than re-resolving the project from `zoi.yaml`. That preserves pinned versions, selected sub-packages, and recorded dependency choices for reproducible project installs.
...
| Parameter        | Type            | Description                                                                                                                                                 |
| ---------------- | --------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `package_name`   | `&str`          | The package identifier to uninstall. Use an explicit source such as `#handle@repo/name[:sub]@version` when multiple installed packages share the same name. |
