...
- `.zoi/imports/<alias>`: cloned repositories declared by `imports()` in `zoi.lua`
- `./zoi.lock`: pinned registries, imports, root requirements, package provenance, and selections
- `./zoi.lua`: declarative project and repository configuration
