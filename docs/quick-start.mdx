...
Zoi links package binaries into its user data directory under `zoi/pkgs/bin`. If commands installed by Zoi are not found, configure your shell completions and PATH. See [Storage Locations](/docs/zds/zoi/storage) for the exact platform path:
...
| Problem                                     | Fix                                                                             |
| ------------------------------------------- | ------------------------------------------------------------------------------- |
| Installed commands are not found            | Run `zoi shell <shell>` or add Zoi's user `pkgs/bin` directory to `PATH`.       |
