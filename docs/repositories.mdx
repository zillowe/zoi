...
| `authorities` | `list` of `string`  | (Optional) A list of PGP fingerprints or key names trusted to sign the registry's Git commits. See [Registry Verification](#registry-verification).                  |
