...
1. Porting existing packages from other systems (Homebrew, APT, etc.) to Zoi's `.pkg.lua` format.
2. Migrating your existing Zoi v1 projects and configurations to **Zoi Specification v2** (introduced in Zoi v1.20.0).
...
## General Concept Mapping (Other Managers)
