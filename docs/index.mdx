...
- **Dynamic Package Definitions:** Define packages with dynamic Lua scripts for maximum flexibility
- **Extensive Dependency Management:** Integrates with over 40 package managers.
- **And much more!** [See the full list of features](/docs/zds/zoi/features).
