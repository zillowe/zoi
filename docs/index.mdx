...
<Accordions type="single">
  ...
  <Accordion title="What is 'zoi dev' and how does it differ from 'zoi env'?">
    ...
    environment variables like `PATH`, `LD_LIBRARY_PATH`, and `CPATH` so you
    can immediately start compiling or running your code. `zoi env` is more
    focused on running specific setup scripts or one-off environment configurations.
  </Accordion>
